...
At the beginning of the thesis, there is the introduction into problems of dynamic languages evaluation~\ref{introduction}. Following is the analysis of possible solutions how to implement the bytecode disassembler~\ref{analysis-of-disassembler} and the debugger~\ref{analysis-of-debugger}. In the middle of work there is design of current implementation~\ref{realization}. After that there is described what type of testing has been done on the work~\ref{testing-and-future-work}. At the end, there is proposed work for the future improvements of the work~\ref{testing-and-future-work} followed by thesis summarization in conclusion.
