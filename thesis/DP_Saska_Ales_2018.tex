...
Because in the during bytecode debugging inside \textbf{bcEval} function there are no runtime checks for the RDEBUG flag due to performance reasons there is need for setting the bytecode instruction~\ref{setting-next-breakpoint} in order to dispatch bytecode functionality manually.
