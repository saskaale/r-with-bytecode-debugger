...
typedef struct RCNTXT {
    ...
    SEXP* bctmpbreakpoints;      /* R_NilValue or vector of positions
                                    of temporary breakpoints inside bcbody */
...
extern0 SEXP*    R_BCtmpBreakpoints INI_as(0); /* R_NilValue or vector
...
extern int	R_DebugVerbose	INI_as(FALSE);	/* verbose debug option */
...
extern0 R_bcstack_t *R_BCNodeStackBase, *R_BCNodeStackTop, *R_BCNodeStackFnBase, *R_BCNodeStackEnd;
#ifdef BC_INT_STACK
...
Rboolean R_is_bc_debug_enabled(void);
